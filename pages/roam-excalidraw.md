...
(defn get-data-block-uid [x]
  (rd/q '[:find ?drawing-uid .
          ...
          :where [?e :block/uid ?uid]
                  ...
                  [?c :block/order 0]
                  [?c :block/string ?s]
                  [(clojure.string/includes? ?s "((de65b229-85a7-40c6-9f01-02debd268746))")]
...
(defn save-component [x] 
  ...
  (let [data-block-uid (get-data-block-uid (:block-uid x))
    ...
    (let [elements (update-elements-with-parts {:raw-elements (:elements edn-map) :text-elements @text-elements})  
          ...
          render-string (str/join ["{{roam/render  ((de65b229-85a7-40c6-9f01-02debd268746)) " out-string " }}"])]
      (block-update
...
;;are missing)
  ...
  (let [default-data {:appState {:theme (:mode @app-settings)}
    ...
    (create-block (:block-uid x) 0 (str/join ["{{roam/render  ((de65b229-85a7-40c6-9f01-02debd268746)) "
                                (str default-data) " }}"]))
...
```
id:: 0d2c2438-70b3-42b7-b50b-bfe543caab4b
...
```
id:: de65b229-85a7-40c6-9f01-02debd268746
